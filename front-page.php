 ...
 *
 * This is the template that displays home page if it is static page.
 *
 * @package WordPress
 * @subpackage akad
 * @since akad 1.0
	...
	<div class="container">
		<div class="agency">
			<div class="col-md-5 col-sm-12">
				<div class="row">
					<img src="dist/images/agency.jpg" alt="image">
				</div>
			</div>
	...
	<section class="services">
		<div class="container">
			...
			<div class="col-md-5 col-sm-12 services-right wow fadeInUp" data-wow-delay=".1s">
				<div class="row">
					<img src="dist/images/serv.jpg" alt="image">
				</div>
			</div>
				...
				<div class="row portfolio_container">
					...
					<div class="col-md-4 photography">
						<a href="single-project.html" class="portfolio_item work-grid wow fadeInUp">
							<img src="dist/images/work-1.jpg" alt="image">
					...
					<div class="col-md-4 fashion logo">
						<a href="single-project.html" class="portfolio_item work-grid wow fadeInUp" data-wow-delay=".2s">
							<img src="dist/images/work-2.jpg" alt="image">
							<div class="portfolio_item_hover">
								<div class="item_info">
									<span>super man</span>
									<em>photography</em>
					...
					<div class="col-md-4 ads graphics">
						<a href="single-project.html" class="portfolio_item work-grid wow fadeInUp" data-wow-delay=".3s">
							<img src="dist/images/work-3.jpg" alt="image">
							<div class="portfolio_item_hover">
								<div class="item_info">
									<span>bat man</span>
									<em>photography</em>
